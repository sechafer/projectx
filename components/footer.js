...
const Footer = () => {
    ...
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
          <Link href={'/homedecor'}>
            <a className="text-gray-600 hover:text-gray-800">Home Decor</a></Link>
          </li>
          <li>
          <Link href={'/pottery'}>
          <a className="text-gray-600 hover:text-gray-800">Pottery</a>
          </Link>
          </li>
          <li>
          <Link href={'/ceramics'}>
          <a className="text-gray-600 hover:text-gray-800">Ceramics</a>
          </Link>
          </li>
          <li>
          <Link href={'/embriodery'}>
          <a className="text-gray-600 hover:text-gray-800">Embroidery</a>
          </Link>
          </li>
        </nav>
      </div>
  ...
  <div className="bg-gray-100">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© 2022 The Craft House- All rights reserved
