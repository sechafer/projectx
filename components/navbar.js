  ...
  return (
    ...
    {dropdown && <div onMouseOver={() => { setdropdown(true) }} onMouseLeave={() => { setdropdown(false) }} className="absolute py-4 right-6 rounded-md  w-36 px-6 bg-white border shadow-lg top-12 z-20">
      <ul>
        ...
        <Link href={'/sellerPortal'} ><a><li className='py-1 hover:text-blue-700 font-bold text-sm'>Seller Portal</li></a></Link>
      ...
      <Link href={"/"}>
        <a>
          <div className=" logo mr-16 flex items-center justify-start  text-gray-900">
            <Image src={'/logo.png'} alt="The Craft kingdom" width={100} height="80" />
            <span className=' text-3xl md:text-3xl font-serif text-pink-600'><b>The Craft kingdom</b>
            </span>
          </div>
        </a>
      </Link>
